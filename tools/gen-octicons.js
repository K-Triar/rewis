// docs/rewis-v2/assets/octicons/*.svg を読み、editor-graph/icons.js を生成する。
...
const outFile = path.join(rootDir, 'editor-graph', 'icons.js');
...
// ライセンス: editor-graph/icons-LICENSE（MIT, github/primer/octicons）
export const ICONS = {
${lines.join(',\n')}
};
`;
